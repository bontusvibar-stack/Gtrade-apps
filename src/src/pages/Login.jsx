...
export default function Login() {
  ...
  const handleGoogle = async () => {
    ...
    // Supabase redirects the whole page to Google and back, so there's
    // nothing to navigate() here — AuthContext picks up the session via
    // onAuthStateChange once the browser lands back on /dashboard.
  ...
  return (
    <div style={styles.wrap}>
      <form style={styles.card} onSubmit={handleSubmit}>
        ...
        <p style={styles.googleNote}>Akun yang sama di device manapun otomatis tersambung.</p>
